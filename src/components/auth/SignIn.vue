<template>
  <div class="flex flex-col items-center content-center">
    <form class="p-fluid" @submit="handleFormSubmit">
      ...
      <div class="field mt-4 mb-5 flex">
        <div>
      ...
      <button
        type="submit"
        class="btn-primary mt-5 flex p-1 border-none border-round hover:bg-black-alpha-20 bg-red-100"
...
function sendResetEmail() {
  ...
  // roarfirekit.value.forg-tPassword(forgotEmail.value);
